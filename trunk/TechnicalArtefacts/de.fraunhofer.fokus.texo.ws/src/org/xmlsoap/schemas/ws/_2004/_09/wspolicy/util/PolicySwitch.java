...
public class PolicySwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PolicyPackage.APPLIES_TO_TYPE1: {
				AppliesToType1 appliesToType1 = (AppliesToType1)theEObject;
				T result = caseAppliesToType1(appliesToType1);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case PolicyPackage.OPERATOR_CONTENT_TYPE1: {
				OperatorContentType1 operatorContentType1 = (OperatorContentType1)theEObject;
				T result = caseOperatorContentType1(operatorContentType1);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case PolicyPackage.POLICY_ATTACHMENT_TYPE1: {
				PolicyAttachmentType1 policyAttachmentType1 = (PolicyAttachmentType1)theEObject;
				T result = casePolicyAttachmentType1(policyAttachmentType1);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case PolicyPackage.POLICY_REFERENCE_TYPE1: {
				PolicyReferenceType1 policyReferenceType1 = (PolicyReferenceType1)theEObject;
				T result = casePolicyReferenceType1(policyReferenceType1);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case PolicyPackage.POLICY_TYPE1: {
				PolicyType1 policyType1 = (PolicyType1)theEObject;
				T result = casePolicyType1(policyType1);
				if (result == null) result = caseOperatorContentType1(policyType1);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Applies To Type1</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Applies To Type1</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAppliesToType1(AppliesToType1 object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Operator Content Type1</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Operator Content Type1</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOperatorContentType1(OperatorContentType1 object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Attachment Type1</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Attachment Type1</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePolicyAttachmentType1(PolicyAttachmentType1 object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T casePolicyReferenceType1(PolicyReferenceType1 object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T casePolicyType1(PolicyType1 object) {
		return null;
	}
