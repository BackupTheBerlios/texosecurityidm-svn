...
/**
 * This is the item provider adapter for a {@link org.open.oasis.docs.wss._2004._01.oasis._200401.wss.wssecurity.secext._1.wssecuritysecext.SecurityTokenReferenceType1} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SecurityTokenReferenceType1ItemProvider
	 ...
	 * @generated
	 */
	public SecurityTokenReferenceType1ItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SecurityTokenReferenceType1_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SecurityTokenReferenceType1_id_feature", "_UI_SecurityTokenReferenceType1_type"),
				 _0Package.Literals.SECURITY_TOKEN_REFERENCE_TYPE1__ID,
				 true,
				 false,
				 false,
	...
	protected void addUsagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SecurityTokenReferenceType1_usage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SecurityTokenReferenceType1_usage_feature", "_UI_SecurityTokenReferenceType1_type"),
				 _0Package.Literals.SECURITY_TOKEN_REFERENCE_TYPE1__USAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(_0Package.Literals.SECURITY_TOKEN_REFERENCE_TYPE1__GROUP);
			childrenFeatures.add(_0Package.Literals.SECURITY_TOKEN_REFERENCE_TYPE1__ANY_ATTRIBUTE);
		}
	...
	/**
	 * This returns SecurityTokenReferenceType1.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SecurityTokenReferenceType1"));
	}
	...
	public String getText(Object object) {
		String label = ((SecurityTokenReferenceType1)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_SecurityTokenReferenceType1_type") :
			getString("_UI_SecurityTokenReferenceType1_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SecurityTokenReferenceType1.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(_0Package.Literals.SECURITY_TOKEN_REFERENCE_TYPE1__GROUP,
