...
/**
 * This is the item provider adapter for a {@link org.open.oasis.docs.ws.sx.ws.securitypolicy.wssecuritypolicy.SePartsType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SePartsTypeItemProvider
	 ...
	 * @generated
	 */
	public SePartsTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(_200702Package.Literals.SE_PARTS_TYPE__BODY);
			childrenFeatures.add(_200702Package.Literals.SE_PARTS_TYPE__HEADER);
			childrenFeatures.add(_200702Package.Literals.SE_PARTS_TYPE__ATTACHMENTS);
			childrenFeatures.add(_200702Package.Literals.SE_PARTS_TYPE__ANY);
			childrenFeatures.add(_200702Package.Literals.SE_PARTS_TYPE__ANY_ATTRIBUTE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SePartsType"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_SePartsType_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SePartsType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(_200702Package.Literals.SE_PARTS_TYPE__BODY,
				 _200702Factory.eINSTANCE.createEmptyType()));

		newChildDescriptors.add
			(createChildParameter
				(_200702Package.Literals.SE_PARTS_TYPE__HEADER,
				 _200702Factory.eINSTANCE.createHeaderType()));

		newChildDescriptors.add
			(createChildParameter
				(_200702Package.Literals.SE_PARTS_TYPE__ATTACHMENTS,
				 _200702Factory.eINSTANCE.createEmptyType()));

		newChildDescriptors.add
			(createChildParameter
				(_200702Package.Literals.SE_PARTS_TYPE__ANY,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == _200702Package.Literals.SE_PARTS_TYPE__BODY ||
			childFeature == _200702Package.Literals.SE_PARTS_TYPE__ATTACHMENTS ||
