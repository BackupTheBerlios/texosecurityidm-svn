...
/**
 * This is the item provider adapter for a {@link org.open.oasis.docs.ws.sx.ws.trust.wstrust.UseKeyType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UseKeyTypeItemProvider
	 ...
	 * @generated
	 */
	public UseKeyTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSigPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Sig feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSigPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UseKeyType_sig_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UseKeyType_sig_feature", "_UI_UseKeyType_type"),
				 _200512Package.Literals.USE_KEY_TYPE__SIG,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(_200512Package.Literals.USE_KEY_TYPE__ANY);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UseKeyType"));
	}
	...
	public String getText(Object object) {
		String label = ((UseKeyType)object).getSig();
		return label == null || label.length() == 0 ?
			getString("_UI_UseKeyType_type") :
			getString("_UI_UseKeyType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UseKeyType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(_200512Package.Literals.USE_KEY_TYPE__ANY,
