...
/**
 * This is the item provider adapter for a {@link org.open.oasis.docs.wss._2004._01.oasis._200401.wss.wssecurity.secext._1.wssecuritysecext.EmbeddedType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EmbeddedTypeItemProvider
	 ...
	 * @generated
	 */
	public EmbeddedTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EmbeddedType_valueType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EmbeddedType_valueType_feature", "_UI_EmbeddedType_type"),
				 _0Package.Literals.EMBEDDED_TYPE__VALUE_TYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(_0Package.Literals.EMBEDDED_TYPE__GROUP);
			childrenFeatures.add(_0Package.Literals.EMBEDDED_TYPE__ANY_ATTRIBUTE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EmbeddedType"));
	}
	...
	public String getText(Object object) {
		String label = ((EmbeddedType)object).getValueType();
		return label == null || label.length() == 0 ?
			getString("_UI_EmbeddedType_type") :
			getString("_UI_EmbeddedType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EmbeddedType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(_0Package.Literals.EMBEDDED_TYPE__GROUP,
