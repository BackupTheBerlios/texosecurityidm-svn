...
/**
 * This is the item provider adapter for a {@link org.open.oasis.docs.ws.sx.ws.trust.wstrust.RequestSecurityTokenType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RequestSecurityTokenTypeItemProvider
	 ...
	 * @generated
	 */
	public RequestSecurityTokenTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RequestSecurityTokenType_context_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RequestSecurityTokenType_context_feature", "_UI_RequestSecurityTokenType_type"),
				 _200512Package.Literals.REQUEST_SECURITY_TOKEN_TYPE__CONTEXT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(_200512Package.Literals.REQUEST_SECURITY_TOKEN_TYPE__ANY);
			childrenFeatures.add(_200512Package.Literals.REQUEST_SECURITY_TOKEN_TYPE__ANY_ATTRIBUTE);
		}
	...
	/**
	 * This returns RequestSecurityTokenType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RequestSecurityTokenType"));
	}
	...
	public String getText(Object object) {
		String label = ((RequestSecurityTokenType)object).getContext();
		return label == null || label.length() == 0 ?
			getString("_UI_RequestSecurityTokenType_type") :
			getString("_UI_RequestSecurityTokenType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RequestSecurityTokenType.class)) {
			case _200512Package.REQUEST_SECURITY_TOKEN_TYPE__CONTEXT:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case _200512Package.REQUEST_SECURITY_TOKEN_TYPE__ANY:
			case _200512Package.REQUEST_SECURITY_TOKEN_TYPE__ANY_ATTRIBUTE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(_200512Package.Literals.REQUEST_SECURITY_TOKEN_TYPE__ANY,
