...
/**
 * This is the item provider adapter for a {@link org.open.oasis.docs.ws.sx.ws.trust.wstrust.AuthenticatorType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AuthenticatorTypeItemProvider
	 ...
	 * @generated
	 */
	public AuthenticatorTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AuthenticatorType_combinedHash_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AuthenticatorType_combinedHash_feature", "_UI_AuthenticatorType_type"),
				 _200512Package.Literals.AUTHENTICATOR_TYPE__COMBINED_HASH,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(_200512Package.Literals.AUTHENTICATOR_TYPE__ANY);
		}
	...
	/**
	 * This returns AuthenticatorType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AuthenticatorType"));
	}
	...
	public String getText(Object object) {
		byte[] labelValue = ((AuthenticatorType)object).getCombinedHash();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_AuthenticatorType_type") :
			getString("_UI_AuthenticatorType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AuthenticatorType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(_200512Package.Literals.AUTHENTICATOR_TYPE__ANY,
