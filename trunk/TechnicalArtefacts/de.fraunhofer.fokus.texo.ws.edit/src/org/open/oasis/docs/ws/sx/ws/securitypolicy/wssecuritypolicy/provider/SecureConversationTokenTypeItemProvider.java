...
/**
 * This is the item provider adapter for a {@link org.open.oasis.docs.ws.sx.ws.securitypolicy.wssecuritypolicy.SecureConversationTokenType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SecureConversationTokenTypeItemProvider
	 ...
	 * @generated
	 */
	public SecureConversationTokenTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SecureConversationTokenType_issuerName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SecureConversationTokenType_issuerName_feature", "_UI_SecureConversationTokenType_type"),
				 _200702Package.Literals.SECURE_CONVERSATION_TOKEN_TYPE__ISSUER_NAME,
				 true,
				 false,
				 false,
	...
	protected void addIncludeTokenPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SecureConversationTokenType_includeToken_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SecureConversationTokenType_includeToken_feature", "_UI_SecureConversationTokenType_type"),
				 _200702Package.Literals.SECURE_CONVERSATION_TOKEN_TYPE__INCLUDE_TOKEN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(_200702Package.Literals.SECURE_CONVERSATION_TOKEN_TYPE__ISSUER);
			childrenFeatures.add(_200702Package.Literals.SECURE_CONVERSATION_TOKEN_TYPE__ANY);
			childrenFeatures.add(_200702Package.Literals.SECURE_CONVERSATION_TOKEN_TYPE__ANY_ATTRIBUTE);
		}
	...
	/**
	 * This returns SecureConversationTokenType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SecureConversationTokenType"));
	}
	...
	public String getText(Object object) {
		String label = ((SecureConversationTokenType)object).getIssuerName();
		return label == null || label.length() == 0 ?
			getString("_UI_SecureConversationTokenType_type") :
			getString("_UI_SecureConversationTokenType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SecureConversationTokenType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(_200702Package.Literals.SECURE_CONVERSATION_TOKEN_TYPE__ISSUER,
				 AddressingFactory.eINSTANCE.createEndpointReferenceType()));

		newChildDescriptors.add
			(createChildParameter
				(_200702Package.Literals.SECURE_CONVERSATION_TOKEN_TYPE__ANY,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == _200702Package.Literals.SECURE_CONVERSATION_TOKEN_TYPE__ISSUER ||
