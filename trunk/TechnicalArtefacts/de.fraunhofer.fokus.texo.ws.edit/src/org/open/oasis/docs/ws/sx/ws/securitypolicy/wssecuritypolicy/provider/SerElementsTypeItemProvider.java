...
/**
 * This is the item provider adapter for a {@link org.open.oasis.docs.ws.sx.ws.securitypolicy.wssecuritypolicy.SerElementsType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SerElementsTypeItemProvider
	 ...
	 * @generated
	 */
	public SerElementsTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addXPathVersionPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SerElementsType_xPath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SerElementsType_xPath_feature", "_UI_SerElementsType_type"),
				 _200702Package.Literals.SER_ELEMENTS_TYPE__XPATH,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the XPath Version feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addXPathVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SerElementsType_xPathVersion_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SerElementsType_xPathVersion_feature", "_UI_SerElementsType_type"),
				 _200702Package.Literals.SER_ELEMENTS_TYPE__XPATH_VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(_200702Package.Literals.SER_ELEMENTS_TYPE__ANY);
			childrenFeatures.add(_200702Package.Literals.SER_ELEMENTS_TYPE__ANY_ATTRIBUTE);
		}
	...
	/**
	 * This returns SerElementsType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SerElementsType"));
	}
	...
	public String getText(Object object) {
		String label = ((SerElementsType)object).getXPathVersion();
		return label == null || label.length() == 0 ?
			getString("_UI_SerElementsType_type") :
			getString("_UI_SerElementsType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SerElementsType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(_200702Package.Literals.SER_ELEMENTS_TYPE__ANY,
