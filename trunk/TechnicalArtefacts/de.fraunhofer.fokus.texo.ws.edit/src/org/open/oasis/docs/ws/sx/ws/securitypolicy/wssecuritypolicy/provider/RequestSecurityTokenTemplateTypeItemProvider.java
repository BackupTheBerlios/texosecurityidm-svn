...
/**
 * This is the item provider adapter for a {@link org.open.oasis.docs.ws.sx.ws.securitypolicy.wssecuritypolicy.RequestSecurityTokenTemplateType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RequestSecurityTokenTemplateTypeItemProvider
	 ...
	 * @generated
	 */
	public RequestSecurityTokenTemplateTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addTrustVersionPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Trust Version feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTrustVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RequestSecurityTokenTemplateType_trustVersion_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RequestSecurityTokenTemplateType_trustVersion_feature", "_UI_RequestSecurityTokenTemplateType_type"),
				 _200702Package.Literals.REQUEST_SECURITY_TOKEN_TEMPLATE_TYPE__TRUST_VERSION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(_200702Package.Literals.REQUEST_SECURITY_TOKEN_TEMPLATE_TYPE__ANY);
			childrenFeatures.add(_200702Package.Literals.REQUEST_SECURITY_TOKEN_TEMPLATE_TYPE__ANY_ATTRIBUTE);
		}
	...
	/**
	 * This returns RequestSecurityTokenTemplateType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RequestSecurityTokenTemplateType"));
	}
	...
	public String getText(Object object) {
		String label = ((RequestSecurityTokenTemplateType)object).getTrustVersion();
		return label == null || label.length() == 0 ?
			getString("_UI_RequestSecurityTokenTemplateType_type") :
			getString("_UI_RequestSecurityTokenTemplateType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RequestSecurityTokenTemplateType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(_200702Package.Literals.REQUEST_SECURITY_TOKEN_TEMPLATE_TYPE__ANY,
