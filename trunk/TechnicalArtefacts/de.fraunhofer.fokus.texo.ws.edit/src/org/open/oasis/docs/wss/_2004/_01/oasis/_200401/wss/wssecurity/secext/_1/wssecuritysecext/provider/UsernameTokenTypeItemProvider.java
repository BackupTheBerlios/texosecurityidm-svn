...
/**
 * This is the item provider adapter for a {@link org.open.oasis.docs.wss._2004._01.oasis._200401.wss.wssecurity.secext._1.wssecuritysecext.UsernameTokenType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UsernameTokenTypeItemProvider
	 ...
	 * @generated
	 */
	public UsernameTokenTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UsernameTokenType_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UsernameTokenType_id_feature", "_UI_UsernameTokenType_type"),
				 _0Package.Literals.USERNAME_TOKEN_TYPE__ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(_0Package.Literals.USERNAME_TOKEN_TYPE__USERNAME);
			childrenFeatures.add(_0Package.Literals.USERNAME_TOKEN_TYPE__ANY);
			childrenFeatures.add(_0Package.Literals.USERNAME_TOKEN_TYPE__ANY_ATTRIBUTE);
		}
	...
	/**
	 * This returns UsernameTokenType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UsernameTokenType"));
	}
	...
	public String getText(Object object) {
		String label = ((UsernameTokenType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_UsernameTokenType_type") :
			getString("_UI_UsernameTokenType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UsernameTokenType.class)) {
			case _0Package.USERNAME_TOKEN_TYPE__ID:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case _0Package.USERNAME_TOKEN_TYPE__USERNAME:
			case _0Package.USERNAME_TOKEN_TYPE__ANY:
			case _0Package.USERNAME_TOKEN_TYPE__ANY_ATTRIBUTE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(_0Package.Literals.USERNAME_TOKEN_TYPE__USERNAME,
				 _0Factory.eINSTANCE.createAttributedString()));
		...
		newChildDescriptors.add
			(createChildParameter
				(_0Package.Literals.USERNAME_TOKEN_TYPE__ANY,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == _0Package.Literals.USERNAME_TOKEN_TYPE__USERNAME ||
			...
			childFeature == _0Package.Literals.DOCUMENT_ROOT__PASSWORD1 ||
