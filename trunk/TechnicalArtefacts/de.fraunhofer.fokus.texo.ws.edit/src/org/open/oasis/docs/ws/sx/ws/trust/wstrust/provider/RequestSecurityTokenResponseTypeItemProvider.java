...
/**
 * This is the item provider adapter for a {@link org.open.oasis.docs.ws.sx.ws.trust.wstrust.RequestSecurityTokenResponseType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RequestSecurityTokenResponseTypeItemProvider
	 ...
	 * @generated
	 */
	public RequestSecurityTokenResponseTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RequestSecurityTokenResponseType_context_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RequestSecurityTokenResponseType_context_feature", "_UI_RequestSecurityTokenResponseType_type"),
				 _200512Package.Literals.REQUEST_SECURITY_TOKEN_RESPONSE_TYPE__CONTEXT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(_200512Package.Literals.REQUEST_SECURITY_TOKEN_RESPONSE_TYPE__ANY);
			childrenFeatures.add(_200512Package.Literals.REQUEST_SECURITY_TOKEN_RESPONSE_TYPE__ANY_ATTRIBUTE);
		}
	...
	/**
	 * This returns RequestSecurityTokenResponseType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RequestSecurityTokenResponseType"));
	}
	...
	public String getText(Object object) {
		String label = ((RequestSecurityTokenResponseType)object).getContext();
		return label == null || label.length() == 0 ?
			getString("_UI_RequestSecurityTokenResponseType_type") :
			getString("_UI_RequestSecurityTokenResponseType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RequestSecurityTokenResponseType.class)) {
			case _200512Package.REQUEST_SECURITY_TOKEN_RESPONSE_TYPE__CONTEXT:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case _200512Package.REQUEST_SECURITY_TOKEN_RESPONSE_TYPE__ANY:
			case _200512Package.REQUEST_SECURITY_TOKEN_RESPONSE_TYPE__ANY_ATTRIBUTE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(_200512Package.Literals.REQUEST_SECURITY_TOKEN_RESPONSE_TYPE__ANY,
