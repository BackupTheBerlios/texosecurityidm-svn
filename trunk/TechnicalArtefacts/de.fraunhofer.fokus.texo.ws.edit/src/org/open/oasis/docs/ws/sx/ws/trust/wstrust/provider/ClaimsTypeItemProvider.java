...
/**
 * This is the item provider adapter for a {@link org.open.oasis.docs.ws.sx.ws.trust.wstrust.ClaimsType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClaimsTypeItemProvider
	 ...
	 * @generated
	 */
	public ClaimsTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ClaimsType_dialect_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ClaimsType_dialect_feature", "_UI_ClaimsType_type"),
				 _200512Package.Literals.CLAIMS_TYPE__DIALECT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(_200512Package.Literals.CLAIMS_TYPE__ANY);
			childrenFeatures.add(_200512Package.Literals.CLAIMS_TYPE__ANY_ATTRIBUTE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ClaimsType"));
	}
	...
	public String getText(Object object) {
		String label = ((ClaimsType)object).getDialect();
		return label == null || label.length() == 0 ?
			getString("_UI_ClaimsType_type") :
			getString("_UI_ClaimsType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ClaimsType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(_200512Package.Literals.CLAIMS_TYPE__ANY,
