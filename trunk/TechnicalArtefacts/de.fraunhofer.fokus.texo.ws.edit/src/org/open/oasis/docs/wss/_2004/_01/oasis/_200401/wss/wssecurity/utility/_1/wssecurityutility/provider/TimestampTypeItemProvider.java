...
/**
 * This is the item provider adapter for a {@link org.open.oasis.docs.wss._2004._01.oasis._200401.wss.wssecurity.utility._1.wssecurityutility.TimestampType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TimestampTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TimestampType_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TimestampType_id_feature", "_UI_TimestampType_type"),
				 _0Package.Literals.TIMESTAMP_TYPE__ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(_0Package.Literals.TIMESTAMP_TYPE__CREATED);
			childrenFeatures.add(_0Package.Literals.TIMESTAMP_TYPE__EXPIRES);
			childrenFeatures.add(_0Package.Literals.TIMESTAMP_TYPE__GROUP);
			childrenFeatures.add(_0Package.Literals.TIMESTAMP_TYPE__ANY_ATTRIBUTE);
		}
	...
	public String getText(Object object) {
		String label = ((TimestampType)object).getId();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TimestampType.class)) {
			case _0Package.TIMESTAMP_TYPE__ID:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case _0Package.TIMESTAMP_TYPE__CREATED:
			case _0Package.TIMESTAMP_TYPE__EXPIRES:
			case _0Package.TIMESTAMP_TYPE__GROUP:
			case _0Package.TIMESTAMP_TYPE__ANY_ATTRIBUTE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(_0Package.Literals.TIMESTAMP_TYPE__CREATED,
				 _0Factory.eINSTANCE.createAttributedDateTime()));

		newChildDescriptors.add
			(createChildParameter
				(_0Package.Literals.TIMESTAMP_TYPE__EXPIRES,
				 _0Factory.eINSTANCE.createAttributedDateTime()));

		newChildDescriptors.add
			(createChildParameter
				(_0Package.Literals.TIMESTAMP_TYPE__GROUP,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == _0Package.Literals.TIMESTAMP_TYPE__CREATED ||
			childFeature == _0Package.Literals.TIMESTAMP_TYPE__EXPIRES ||
