...
/**
 * This is the item provider adapter for a {@link org.xmlsoap.schemas.soap.soapenvelope.Envelope} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnvelopeItemProvider
	 ...
	 * @generated
	 */
	public EnvelopeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EnvelopePackage.Literals.ENVELOPE__HEADER);
			childrenFeatures.add(EnvelopePackage.Literals.ENVELOPE__BODY);
			childrenFeatures.add(EnvelopePackage.Literals.ENVELOPE__ANY);
			childrenFeatures.add(EnvelopePackage.Literals.ENVELOPE__ANY_ATTRIBUTE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Envelope"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_Envelope_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Envelope.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EnvelopePackage.Literals.ENVELOPE__HEADER,
				 EnvelopeFactory.eINSTANCE.createHeader()));

		newChildDescriptors.add
			(createChildParameter
				(EnvelopePackage.Literals.ENVELOPE__BODY,
				 EnvelopeFactory.eINSTANCE.createBody()));

		newChildDescriptors.add
			(createChildParameter
				(EnvelopePackage.Literals.ENVELOPE__ANY,
