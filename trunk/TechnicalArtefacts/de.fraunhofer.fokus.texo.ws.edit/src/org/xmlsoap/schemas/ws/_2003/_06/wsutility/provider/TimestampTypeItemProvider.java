...
/**
 * This is the item provider adapter for a {@link org.xmlsoap.schemas.ws._2003._06.wsutility.TimestampType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TimestampTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UtilityPackage.Literals.TIMESTAMP_TYPE__ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UtilityPackage.Literals.TIMESTAMP_TYPE__CREATED);
			childrenFeatures.add(UtilityPackage.Literals.TIMESTAMP_TYPE__EXPIRES);
			childrenFeatures.add(UtilityPackage.Literals.TIMESTAMP_TYPE__GROUP);
			childrenFeatures.add(UtilityPackage.Literals.TIMESTAMP_TYPE__ANY_ATTRIBUTE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UtilityPackage.Literals.TIMESTAMP_TYPE__CREATED,
				 UtilityFactory.eINSTANCE.createAttributedDateTime()));

		newChildDescriptors.add
			(createChildParameter
				(UtilityPackage.Literals.TIMESTAMP_TYPE__EXPIRES,
				 UtilityFactory.eINSTANCE.createAttributedDateTime()));

		newChildDescriptors.add
			(createChildParameter
				(UtilityPackage.Literals.TIMESTAMP_TYPE__GROUP,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == UtilityPackage.Literals.TIMESTAMP_TYPE__CREATED ||
			childFeature == UtilityPackage.Literals.TIMESTAMP_TYPE__EXPIRES ||
