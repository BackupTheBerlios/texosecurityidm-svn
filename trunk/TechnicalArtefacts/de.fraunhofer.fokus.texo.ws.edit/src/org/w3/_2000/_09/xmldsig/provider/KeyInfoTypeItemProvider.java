...
/**
 * This is the item provider adapter for a {@link org.w3._2000._09.xmldsig.KeyInfoType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class KeyInfoTypeItemProvider
	 ...
	 * @generated
	 */
	public KeyInfoTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_KeyInfoType_keyName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_KeyInfoType_keyName_feature", "_UI_KeyInfoType_type"),
				 XmldsigPackage.Literals.KEY_INFO_TYPE__KEY_NAME,
				 true,
				 false,
				 false,
	...
	protected void addMgmtDataPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_KeyInfoType_mgmtData_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_KeyInfoType_mgmtData_feature", "_UI_KeyInfoType_type"),
				 XmldsigPackage.Literals.KEY_INFO_TYPE__MGMT_DATA,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_KeyInfoType_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_KeyInfoType_id_feature", "_UI_KeyInfoType_type"),
				 XmldsigPackage.Literals.KEY_INFO_TYPE__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XmldsigPackage.Literals.KEY_INFO_TYPE__MIXED);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/KeyInfoType"));
	}
	...
	public String getText(Object object) {
		String label = ((KeyInfoType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_KeyInfoType_type") :
			getString("_UI_KeyInfoType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(KeyInfoType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XmldsigPackage.Literals.KEY_INFO_TYPE__MIXED,
		...
		newChildDescriptors.add
			(createChildParameter
				(XmldsigPackage.Literals.KEY_INFO_TYPE__MIXED,
				 FeatureMapUtil.createEntry
					(XmldsigPackage.Literals.KEY_INFO_TYPE__KEY_VALUE,
		...
		newChildDescriptors.add
			(createChildParameter
				(XmldsigPackage.Literals.KEY_INFO_TYPE__MIXED,
				 FeatureMapUtil.createEntry
					(XmldsigPackage.Literals.KEY_INFO_TYPE__RETRIEVAL_METHOD,
		...
		newChildDescriptors.add
			(createChildParameter
				(XmldsigPackage.Literals.KEY_INFO_TYPE__MIXED,
				 FeatureMapUtil.createEntry
					(XmldsigPackage.Literals.KEY_INFO_TYPE__X509_DATA,
		...
		newChildDescriptors.add
			(createChildParameter
				(XmldsigPackage.Literals.KEY_INFO_TYPE__MIXED,
				 FeatureMapUtil.createEntry
					(XmldsigPackage.Literals.KEY_INFO_TYPE__PGP_DATA,
		...
		newChildDescriptors.add
			(createChildParameter
				(XmldsigPackage.Literals.KEY_INFO_TYPE__MIXED,
				 FeatureMapUtil.createEntry
					(XmldsigPackage.Literals.KEY_INFO_TYPE__SPKI_DATA,
