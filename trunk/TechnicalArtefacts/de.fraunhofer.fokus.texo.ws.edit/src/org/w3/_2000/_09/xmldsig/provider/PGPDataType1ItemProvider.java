...
/**
 * This is the item provider adapter for a {@link org.w3._2000._09.xmldsig.PGPDataType1} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PGPDataType1ItemProvider
	 ...
	 * @generated
	 */
	public PGPDataType1ItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addPGPKeyIDPropertyDescriptor(object);
			addPGPKeyPacketPropertyDescriptor(object);
			addPGPKeyPacket1PropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the PGP Key ID feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addPGPKeyIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PGPDataType1_pGPKeyID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PGPDataType1_pGPKeyID_feature", "_UI_PGPDataType1_type"),
				 XmldsigPackage.Literals.PGP_DATA_TYPE1__PGP_KEY_ID,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the PGP Key Packet feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addPGPKeyPacketPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PGPDataType1_pGPKeyPacket_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PGPDataType1_pGPKeyPacket_feature", "_UI_PGPDataType1_type"),
				 XmldsigPackage.Literals.PGP_DATA_TYPE1__PGP_KEY_PACKET,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the PGP Key Packet1 feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addPGPKeyPacket1PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PGPDataType1_pGPKeyPacket1_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PGPDataType1_pGPKeyPacket1_feature", "_UI_PGPDataType1_type"),
				 XmldsigPackage.Literals.PGP_DATA_TYPE1__PGP_KEY_PACKET1,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XmldsigPackage.Literals.PGP_DATA_TYPE1__ANY);
			childrenFeatures.add(XmldsigPackage.Literals.PGP_DATA_TYPE1__ANY1);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PGPDataType1"));
	}
	...
	public String getText(Object object) {
		byte[] labelValue = ((PGPDataType1)object).getPGPKeyID();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_PGPDataType1_type") :
			getString("_UI_PGPDataType1_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PGPDataType1.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XmldsigPackage.Literals.PGP_DATA_TYPE1__ANY,
