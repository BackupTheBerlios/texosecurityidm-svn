...
/**
 * This is the item provider adapter for a {@link org.w3._2000._09.xmldsig.CanonicalizationMethodType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CanonicalizationMethodTypeItemProvider
	 ...
	 * @generated
	 */
	public CanonicalizationMethodTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CanonicalizationMethodType_algorithm_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CanonicalizationMethodType_algorithm_feature", "_UI_CanonicalizationMethodType_type"),
				 XmldsigPackage.Literals.CANONICALIZATION_METHOD_TYPE__ALGORITHM,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XmldsigPackage.Literals.CANONICALIZATION_METHOD_TYPE__MIXED);
		}
	...
	/**
	 * This returns CanonicalizationMethodType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CanonicalizationMethodType"));
	}
	...
	public String getText(Object object) {
		String label = ((CanonicalizationMethodType)object).getAlgorithm();
		return label == null || label.length() == 0 ?
			getString("_UI_CanonicalizationMethodType_type") :
			getString("_UI_CanonicalizationMethodType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CanonicalizationMethodType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XmldsigPackage.Literals.CANONICALIZATION_METHOD_TYPE__MIXED,
