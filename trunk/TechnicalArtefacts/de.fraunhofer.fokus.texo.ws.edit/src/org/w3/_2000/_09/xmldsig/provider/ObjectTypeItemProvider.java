...
/**
 * This is the item provider adapter for a {@link org.w3._2000._09.xmldsig.ObjectType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ObjectTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ObjectType_encoding_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ObjectType_encoding_feature", "_UI_ObjectType_type"),
				 XmldsigPackage.Literals.OBJECT_TYPE__ENCODING,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 XmldsigPackage.Literals.OBJECT_TYPE__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addMimeTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ObjectType_mimeType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ObjectType_mimeType_feature", "_UI_ObjectType_type"),
				 XmldsigPackage.Literals.OBJECT_TYPE__MIME_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XmldsigPackage.Literals.OBJECT_TYPE__MIXED);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XmldsigPackage.Literals.OBJECT_TYPE__MIXED,
