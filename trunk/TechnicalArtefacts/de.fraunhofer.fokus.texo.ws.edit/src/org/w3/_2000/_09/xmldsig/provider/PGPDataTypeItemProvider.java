...
/**
 * This is the item provider adapter for a {@link org.w3._2000._09.xmldsig.PGPDataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PGPDataTypeItemProvider
	 ...
	 * @generated
	 */
	public PGPDataTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PGPDataType_pGPKeyID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PGPDataType_pGPKeyID_feature", "_UI_PGPDataType_type"),
				 XmldsigPackage.Literals.PGP_DATA_TYPE__PGP_KEY_ID,
				 true,
				 false,
				 false,
	...
	protected void addPGPKeyPacketPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PGPDataType_pGPKeyPacket_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PGPDataType_pGPKeyPacket_feature", "_UI_PGPDataType_type"),
				 XmldsigPackage.Literals.PGP_DATA_TYPE__PGP_KEY_PACKET,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPGPKeyPacket1PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PGPDataType_pGPKeyPacket1_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PGPDataType_pGPKeyPacket1_feature", "_UI_PGPDataType_type"),
				 XmldsigPackage.Literals.PGP_DATA_TYPE__PGP_KEY_PACKET1,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XmldsigPackage.Literals.PGP_DATA_TYPE__ANY);
			childrenFeatures.add(XmldsigPackage.Literals.PGP_DATA_TYPE__ANY1);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PGPDataType"));
	}
	...
	public String getText(Object object) {
		byte[] labelValue = ((PGPDataType)object).getPGPKeyID();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_PGPDataType_type") :
			getString("_UI_PGPDataType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PGPDataType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XmldsigPackage.Literals.PGP_DATA_TYPE__ANY,
