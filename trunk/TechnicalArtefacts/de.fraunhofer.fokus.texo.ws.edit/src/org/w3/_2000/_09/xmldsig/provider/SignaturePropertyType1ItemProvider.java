...
/**
 * This is the item provider adapter for a {@link org.w3._2000._09.xmldsig.SignaturePropertyType1} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SignaturePropertyType1ItemProvider
	 ...
	 * @generated
	 */
	public SignaturePropertyType1ItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SignaturePropertyType1_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SignaturePropertyType1_id_feature", "_UI_SignaturePropertyType1_type"),
				 XmldsigPackage.Literals.SIGNATURE_PROPERTY_TYPE1__ID,
				 true,
				 false,
				 false,
	...
	protected void addTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SignaturePropertyType1_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SignaturePropertyType1_target_feature", "_UI_SignaturePropertyType1_type"),
				 XmldsigPackage.Literals.SIGNATURE_PROPERTY_TYPE1__TARGET,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XmldsigPackage.Literals.SIGNATURE_PROPERTY_TYPE1__MIXED);
		}
	...
	/**
	 * This returns SignaturePropertyType1.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SignaturePropertyType1"));
	}
	...
	public String getText(Object object) {
		String label = ((SignaturePropertyType1)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_SignaturePropertyType1_type") :
			getString("_UI_SignaturePropertyType1_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SignaturePropertyType1.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XmldsigPackage.Literals.SIGNATURE_PROPERTY_TYPE1__MIXED,
