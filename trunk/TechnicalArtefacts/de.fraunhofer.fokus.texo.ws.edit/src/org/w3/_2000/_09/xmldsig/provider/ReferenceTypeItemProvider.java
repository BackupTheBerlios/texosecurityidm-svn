...
/**
 * This is the item provider adapter for a {@link org.w3._2000._09.xmldsig.ReferenceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReferenceTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReferenceType_digestValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReferenceType_digestValue_feature", "_UI_ReferenceType_type"),
				 XmldsigPackage.Literals.REFERENCE_TYPE__DIGEST_VALUE,
				 true,
				 false,
				 false,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReferenceType_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReferenceType_id_feature", "_UI_ReferenceType_type"),
				 XmldsigPackage.Literals.REFERENCE_TYPE__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 XmldsigPackage.Literals.REFERENCE_TYPE__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addURIPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReferenceType_uRI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReferenceType_uRI_feature", "_UI_ReferenceType_type"),
				 XmldsigPackage.Literals.REFERENCE_TYPE__URI,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XmldsigPackage.Literals.REFERENCE_TYPE__TRANSFORMS);
			childrenFeatures.add(XmldsigPackage.Literals.REFERENCE_TYPE__DIGEST_METHOD);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XmldsigPackage.Literals.REFERENCE_TYPE__TRANSFORMS,
				 XmldsigFactory.eINSTANCE.createTransformsType()));

		newChildDescriptors.add
			(createChildParameter
				(XmldsigPackage.Literals.REFERENCE_TYPE__DIGEST_METHOD,
