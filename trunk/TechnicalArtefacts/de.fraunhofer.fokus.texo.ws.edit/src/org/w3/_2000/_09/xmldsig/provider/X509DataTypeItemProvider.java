...
/**
 * This is the item provider adapter for a {@link org.w3._2000._09.xmldsig.X509DataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class X509DataTypeItemProvider
	 ...
	 * @generated
	 */
	public X509DataTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_X509DataType_x509SKI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_X509DataType_x509SKI_feature", "_UI_X509DataType_type"),
				 XmldsigPackage.Literals.X509_DATA_TYPE__X509_SKI,
				 true,
				 false,
				 false,
	...
	protected void addX509SubjectNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_X509DataType_x509SubjectName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_X509DataType_x509SubjectName_feature", "_UI_X509DataType_type"),
				 XmldsigPackage.Literals.X509_DATA_TYPE__X509_SUBJECT_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addX509CertificatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_X509DataType_x509Certificate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_X509DataType_x509Certificate_feature", "_UI_X509DataType_type"),
				 XmldsigPackage.Literals.X509_DATA_TYPE__X509_CERTIFICATE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addX509CRLPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_X509DataType_x509CRL_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_X509DataType_x509CRL_feature", "_UI_X509DataType_type"),
				 XmldsigPackage.Literals.X509_DATA_TYPE__X509_CRL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XmldsigPackage.Literals.X509_DATA_TYPE__GROUP);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/X509DataType"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_X509DataType_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(X509DataType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XmldsigPackage.Literals.X509_DATA_TYPE__GROUP,
				 FeatureMapUtil.createEntry
					(XmldsigPackage.Literals.X509_DATA_TYPE__X509_ISSUER_SERIAL,
					 XmldsigFactory.eINSTANCE.createX509IssuerSerialType())));
