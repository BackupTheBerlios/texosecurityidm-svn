...
/**
 * This is the item provider adapter for a {@link org.w3._2000._09.xmldsig.SPKIDataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SPKIDataTypeItemProvider
	 ...
	 * @generated
	 */
	public SPKIDataTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SPKIDataType_sPKISexp_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SPKIDataType_sPKISexp_feature", "_UI_SPKIDataType_type"),
				 XmldsigPackage.Literals.SPKI_DATA_TYPE__SPKI_SEXP,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XmldsigPackage.Literals.SPKI_DATA_TYPE__GROUP);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SPKIDataType"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_SPKIDataType_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SPKIDataType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XmldsigPackage.Literals.SPKI_DATA_TYPE__GROUP,
