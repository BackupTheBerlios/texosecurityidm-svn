...
/**
 * This is the item provider adapter for a {@link org.w3._2000._09.xmldsig.SignatureMethodType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SignatureMethodTypeItemProvider
	 ...
	 * @generated
	 */
	public SignatureMethodTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SignatureMethodType_hMACOutputLength_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SignatureMethodType_hMACOutputLength_feature", "_UI_SignatureMethodType_type"),
				 XmldsigPackage.Literals.SIGNATURE_METHOD_TYPE__HMAC_OUTPUT_LENGTH,
				 true,
				 false,
				 false,
	...
	protected void addAlgorithmPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SignatureMethodType_algorithm_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SignatureMethodType_algorithm_feature", "_UI_SignatureMethodType_type"),
				 XmldsigPackage.Literals.SIGNATURE_METHOD_TYPE__ALGORITHM,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XmldsigPackage.Literals.SIGNATURE_METHOD_TYPE__MIXED);
		}
	...
	/**
	 * This returns SignatureMethodType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SignatureMethodType"));
	}
	...
	public String getText(Object object) {
		BigInteger labelValue = ((SignatureMethodType)object).getHMACOutputLength();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_SignatureMethodType_type") :
			getString("_UI_SignatureMethodType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SignatureMethodType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XmldsigPackage.Literals.SIGNATURE_METHOD_TYPE__MIXED,
		...
		newChildDescriptors.add
			(createChildParameter
				(XmldsigPackage.Literals.SIGNATURE_METHOD_TYPE__MIXED,
				 FeatureMapUtil.createEntry
					(XmldsigPackage.Literals.SIGNATURE_METHOD_TYPE__HMAC_OUTPUT_LENGTH,
					 XmldsigFactory.eINSTANCE.createFromString(XmldsigPackage.Literals.HMAC_OUTPUT_LENGTH_TYPE, "0"))));
