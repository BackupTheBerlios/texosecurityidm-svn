...
/**
 * This is the item provider adapter for a {@link org.w3._2000._09.xmldsig.DigestMethodType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DigestMethodTypeItemProvider
	 ...
	 * @generated
	 */
	public DigestMethodTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DigestMethodType_algorithm_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DigestMethodType_algorithm_feature", "_UI_DigestMethodType_type"),
				 XmldsigPackage.Literals.DIGEST_METHOD_TYPE__ALGORITHM,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XmldsigPackage.Literals.DIGEST_METHOD_TYPE__MIXED);
		}
	...
	/**
	 * This returns DigestMethodType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DigestMethodType"));
	}
	...
	public String getText(Object object) {
		String label = ((DigestMethodType)object).getAlgorithm();
		return label == null || label.length() == 0 ?
			getString("_UI_DigestMethodType_type") :
			getString("_UI_DigestMethodType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DigestMethodType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XmldsigPackage.Literals.DIGEST_METHOD_TYPE__MIXED,
