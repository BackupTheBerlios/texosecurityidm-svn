...
/**
 * This is the item provider adapter for a {@link org.w3._2000._09.xmldsig.CanonicalizationMethodType1} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CanonicalizationMethodType1ItemProvider
	 ...
	 * @generated
	 */
	public CanonicalizationMethodType1ItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CanonicalizationMethodType1_algorithm_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CanonicalizationMethodType1_algorithm_feature", "_UI_CanonicalizationMethodType1_type"),
				 XmldsigPackage.Literals.CANONICALIZATION_METHOD_TYPE1__ALGORITHM,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XmldsigPackage.Literals.CANONICALIZATION_METHOD_TYPE1__MIXED);
		}
	...
	/**
	 * This returns CanonicalizationMethodType1.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CanonicalizationMethodType1"));
	}
	...
	public String getText(Object object) {
		String label = ((CanonicalizationMethodType1)object).getAlgorithm();
		return label == null || label.length() == 0 ?
			getString("_UI_CanonicalizationMethodType1_type") :
			getString("_UI_CanonicalizationMethodType1_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CanonicalizationMethodType1.class)) {
			case XmldsigPackage.CANONICALIZATION_METHOD_TYPE1__ALGORITHM:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case XmldsigPackage.CANONICALIZATION_METHOD_TYPE1__MIXED:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XmldsigPackage.Literals.CANONICALIZATION_METHOD_TYPE1__MIXED,
