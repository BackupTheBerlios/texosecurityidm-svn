...
/**
 * This is the item provider adapter for a {@link org.w3._2000._09.xmldsig.SignatureMethodType1} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SignatureMethodType1ItemProvider
	 ...
	 * @generated
	 */
	public SignatureMethodType1ItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addHMACOutputLengthPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the HMAC Output Length feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addHMACOutputLengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SignatureMethodType1_hMACOutputLength_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SignatureMethodType1_hMACOutputLength_feature", "_UI_SignatureMethodType1_type"),
				 XmldsigPackage.Literals.SIGNATURE_METHOD_TYPE1__HMAC_OUTPUT_LENGTH,
				 true,
				 false,
				 false,
	...
	protected void addAlgorithmPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SignatureMethodType1_algorithm_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SignatureMethodType1_algorithm_feature", "_UI_SignatureMethodType1_type"),
				 XmldsigPackage.Literals.SIGNATURE_METHOD_TYPE1__ALGORITHM,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XmldsigPackage.Literals.SIGNATURE_METHOD_TYPE1__MIXED);
		}
	...
	/**
	 * This returns SignatureMethodType1.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SignatureMethodType1"));
	}
	...
	public String getText(Object object) {
		BigInteger labelValue = ((SignatureMethodType1)object).getHMACOutputLength();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_SignatureMethodType1_type") :
			getString("_UI_SignatureMethodType1_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SignatureMethodType1.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XmldsigPackage.Literals.SIGNATURE_METHOD_TYPE1__MIXED,
		...
		newChildDescriptors.add
			(createChildParameter
				(XmldsigPackage.Literals.SIGNATURE_METHOD_TYPE1__MIXED,
				 FeatureMapUtil.createEntry
					(XmldsigPackage.Literals.SIGNATURE_METHOD_TYPE1__HMAC_OUTPUT_LENGTH,
					 XmldsigFactory.eINSTANCE.createFromString(XmldsigPackage.Literals.HMAC_OUTPUT_LENGTH_TYPE1, "0"))));
