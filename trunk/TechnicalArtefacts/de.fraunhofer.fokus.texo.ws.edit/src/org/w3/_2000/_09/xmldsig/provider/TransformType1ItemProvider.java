...
/**
 * This is the item provider adapter for a {@link org.w3._2000._09.xmldsig.TransformType1} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransformType1ItemProvider
	 ...
	 * @generated
	 */
	public TransformType1ItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TransformType1_xPath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TransformType1_xPath_feature", "_UI_TransformType1_type"),
				 XmldsigPackage.Literals.TRANSFORM_TYPE1__XPATH,
				 true,
				 false,
				 false,
	...
	protected void addAlgorithmPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TransformType1_algorithm_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TransformType1_algorithm_feature", "_UI_TransformType1_type"),
				 XmldsigPackage.Literals.TRANSFORM_TYPE1__ALGORITHM,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XmldsigPackage.Literals.TRANSFORM_TYPE1__MIXED);
		}
	...
	/**
	 * This returns TransformType1.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TransformType1"));
	}
	...
	public String getText(Object object) {
		String label = ((TransformType1)object).getAlgorithm();
		return label == null || label.length() == 0 ?
			getString("_UI_TransformType1_type") :
			getString("_UI_TransformType1_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TransformType1.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XmldsigPackage.Literals.TRANSFORM_TYPE1__MIXED,
