...
/**
 * This is the item provider adapter for a {@link org.w3._2005._08.wsaddressing.EndpointReferenceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EndpointReferenceTypeItemProvider
	 ...
	 * @generated
	 */
	public EndpointReferenceTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AddressingPackage.Literals.ENDPOINT_REFERENCE_TYPE__ADDRESS);
			childrenFeatures.add(AddressingPackage.Literals.ENDPOINT_REFERENCE_TYPE__REFERENCE_PARAMETERS);
			childrenFeatures.add(AddressingPackage.Literals.ENDPOINT_REFERENCE_TYPE__METADATA);
			childrenFeatures.add(AddressingPackage.Literals.ENDPOINT_REFERENCE_TYPE__ANY);
			childrenFeatures.add(AddressingPackage.Literals.ENDPOINT_REFERENCE_TYPE__ANY_ATTRIBUTE);
		}
	...
	/**
	 * This returns EndpointReferenceType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EndpointReferenceType"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_EndpointReferenceType_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EndpointReferenceType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AddressingPackage.Literals.ENDPOINT_REFERENCE_TYPE__ADDRESS,
				 AddressingFactory.eINSTANCE.createAttributedURIType()));

		newChildDescriptors.add
			(createChildParameter
				(AddressingPackage.Literals.ENDPOINT_REFERENCE_TYPE__REFERENCE_PARAMETERS,
				 AddressingFactory.eINSTANCE.createReferenceParametersType()));

		newChildDescriptors.add
			(createChildParameter
				(AddressingPackage.Literals.ENDPOINT_REFERENCE_TYPE__METADATA,
				 AddressingFactory.eINSTANCE.createMetadataType()));

		newChildDescriptors.add
			(createChildParameter
				(AddressingPackage.Literals.ENDPOINT_REFERENCE_TYPE__ANY,
