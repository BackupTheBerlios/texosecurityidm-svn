...
/**
 * This is the item provider adapter for a {@link org.w3._2005._08.wsaddressing.EndpointReferenceType1} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EndpointReferenceType1ItemProvider
	 ...
	 * @generated
	 */
	public EndpointReferenceType1ItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AddressingPackage.Literals.ENDPOINT_REFERENCE_TYPE1__ADDRESS);
			childrenFeatures.add(AddressingPackage.Literals.ENDPOINT_REFERENCE_TYPE1__REFERENCE_PARAMETERS);
			childrenFeatures.add(AddressingPackage.Literals.ENDPOINT_REFERENCE_TYPE1__METADATA);
			childrenFeatures.add(AddressingPackage.Literals.ENDPOINT_REFERENCE_TYPE1__ANY);
			childrenFeatures.add(AddressingPackage.Literals.ENDPOINT_REFERENCE_TYPE1__ANY_ATTRIBUTE);
		}
	...
	/**
	 * This returns EndpointReferenceType1.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EndpointReferenceType1"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_EndpointReferenceType1_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EndpointReferenceType1.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AddressingPackage.Literals.ENDPOINT_REFERENCE_TYPE1__ADDRESS,
				 AddressingFactory.eINSTANCE.createAttributedURIType1()));

		newChildDescriptors.add
			(createChildParameter
				(AddressingPackage.Literals.ENDPOINT_REFERENCE_TYPE1__REFERENCE_PARAMETERS,
				 AddressingFactory.eINSTANCE.createReferenceParametersType1()));

		newChildDescriptors.add
			(createChildParameter
				(AddressingPackage.Literals.ENDPOINT_REFERENCE_TYPE1__METADATA,
				 AddressingFactory.eINSTANCE.createMetadataType1()));

		newChildDescriptors.add
			(createChildParameter
				(AddressingPackage.Literals.ENDPOINT_REFERENCE_TYPE1__ANY,
